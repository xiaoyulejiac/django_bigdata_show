...
def age_data_provider():
    age_data = age_function('8.130.52.33',3306,'root',"xiaoyulejia",'data')
...
def edu_data_provider():
    edu_data = edu_function('8.130.52.33',3306,'root',"xiaoyulejia",'data')
...
def marriage_data_provider():
    marriage_data = marriage_function('8.130.52.33',3306,'root',"xiaoyulejia",'data')
