...
def age_data_provider():
    age_data = age_function('10.211.55.3',3306,'xiaoyulejiatest',"test1234",'xiaoyulejiatest')
...
def edu_data_provider():
    edu_data = edu_function('10.211.55.3',3306,'xiaoyulejiatest',"test1234",'xiaoyulejiatest')
...
def marriage_data_provider():
    marriage_data = marriage_function('10.211.55.3',3306,'xiaoyulejiatest',"test1234",'xiaoyulejiatest')
